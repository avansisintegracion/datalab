...
class GetFeatures(object):
    ...
    def wholeImage(self):
        ...
        for im, id in self.load_images():
            self.ifeatures['o'][id] = np.array(self.features_for(im))
        try:
            with open(self.ifeatures['f'], 'wb') as file:
                p.dump(self.ifeatures['o'], file)
        except:
    ...
    def SURFextractor(self):
        if op.exists(self.alldescriptors['f']) is False:
            ...
            for im, id in self.load_images():
                ...
                self.alldescriptors['o'][id] = surf.surf(gray, descriptor_only=True)
                # i += 1
                # if i > 100:
                #     print(self.alldescriptors)
                #     print(gray)
                #     print(gray.size)
                #     print(gray.shape)
                #     print(self.alldescriptors[id].shape)
                #     print(i)
                #     break
            try:
                with open(self.alldescriptors['f'], 'wb') as file:
                    p.dump(self.alldescriptors['o'], file)
            except:
        ...
        k = 128
        km = KMeans(k)
        concatenated = np.concatenate(self.alldescriptors['o'].values())
        ...
        try:
            with open(self.sfeatures['f'], 'wb') as file:
                p.dump(self.sfeatures['o'], file)
        except:
    ...
    #                 p.dump(self.keras_features, file)
    #         except:
    ...
    #             self.keras_features = p.load(open(op.join(self.basedir, 'kfeatures.txt'), 'rb'))
    #         except:
    ...
    #             self.keras_features = p.load(open(op.join(self.basedir, 'otsu_keras_features.txt'), 'rb'))
    #         except:
    #             print("Issues loading alldescriptors!")
    #             sys.exit(1)
    #
    ...
    #                 p.dump(self.hogdescriptors, file)
    #         except:
    #             print('HOG descriptors not dumped')
    #     else:
    #         try:
    #             print('HOG descriptors alreardy computed, loading..')
    #             self.hogdescriptors = p.load(open(op.join(self.basedir, 'hogdescriptors.txt'), 'rb'))
    #         except:
    ...
    #                 p.dump(self.bloblogdescriptors, file)
    #         except:
    #             print('Blob Log descriptors not dumped')
    #     else:
    #         try:
    #             print('Blob Log descriptors alreardy computed, loading..')
    #             self.bloblogdescriptors = p.load(open(op.join(self.basedir, 'blobORBdescriptors.txt'), 'rb'))
    #         except:
    ...
    #                 p.dump(np.array(self.otsudescriptors), file)
    #         except:
    #             print('Otsu descriptors not dumped')
    #     else:
    #         try:
    #             print('Otsu descriptors already computed, loading..')
    #             self.otsudescriptors = p.load(open(op.join(self.basedir, 'otsudescriptors.txt'), 'rb'))
    #         except:
